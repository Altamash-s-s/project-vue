...
const userBillingGetters = {
  getAddresses: (billing, criteria) => {
    if (!billing || !billing.addresses) return [];
    if (!criteria || Object.keys(criteria).length === 0) {
  ...
  getDefault: billing => billing.addresses.find(({
    default_billing
  }) => default_billing),
...
/* harmony default export */ __webpack_exports__["a"] = (userBillingGetters);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_1_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_15_0_Billing_vue_vue_type_style_index_0_id_1efcdb5e_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(430);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_1_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_15_0_Billing_vue_vue_type_style_index_0_id_1efcdb5e_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_1_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_15_0_Billing_vue_vue_type_style_index_0_id_1efcdb5e_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_1_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_15_0_Billing_vue_vue_type_style_index_0_id_1efcdb5e_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_1_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_15_0_Billing_vue_vue_type_style_index_0_id_1efcdb5e_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/unplugin/dist/webpack/loaders/transform.js??ref--15-0!./modules/checkout/pages/Checkout/Billing.vue?vue&type=template&id=1efcdb5e&scoped=true&
...
// CONCATENATED MODULE: ./modules/checkout/pages/Checkout/Billing.vue?vue&type=template&id=1efcdb5e&scoped=true&
...
// EXTERNAL MODULE: ./modules/customer/getters/userBillingGetters.ts
var userBillingGetters = __webpack_require__(429);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--13-0!./node_modules/ts-loader??ref--13-1!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/unplugin/dist/webpack/loaders/transform.js??ref--15-0!./modules/checkout/pages/Checkout/Billing.vue?vue&type=script&lang=ts&
...
/* harmony default export */ var Billingvue_type_script_lang_ts_ = (Object(runtime["b" /* defineComponent */])({
  name: 'BillingStep',
  components: {
    ...
    UserBillingAddresses: () => __webpack_require__.e(/* import() */ 98).then(__webpack_require__.bind(null, 631)),
  ...
  setup() {
    ...
    const shippingDetails = Object(runtime["l" /* ref */])(null);
    const userBilling = Object(runtime["l" /* ref */])(null);
    const {
      save,
      load: loadBilling,
      loading
    } = Object(useBilling["a" /* default */])();
    const {
      load: loadUserBilling,
      setDefaultAddress
    } = Object(useUserAddress["b" /* useUserAddress */])();
    const {
      load: loadShipping
    ...
    const shippingDetailsCountryName = Object(runtime["a" /* computed */])(() => {
      var _a, _b;
      return (_b = (_a = countries.value.find(countryItem => {
        var _a;
        return countryItem.id === ((_a = shippingDetails.value) === null || _a === void 0 ? void 0 : _a.country.code);
      })) === null || _a === void 0 ? void 0 : _a.full_name_locale) !== null && _b !== void 0 ? _b : '';
    });
    const {
      isAuthenticated
    } = Object(useUser["b" /* useUser */])();
    let oldBilling = null;
    const sameAsShipping = Object(runtime["l" /* ref */])(false);
    const billingDetails = Object(runtime["l" /* ref */])(Object(address["d" /* getInitialCheckoutAddressForm */])());
    const currentAddressId = Object(runtime["l" /* ref */])(null);
    const setAsDefault = Object(runtime["l" /* ref */])(false);
    const isFormSubmitted = Object(runtime["l" /* ref */])(false);
    const isAddNewAddressFormVisible = Object(runtime["l" /* ref */])(true);
    const isBillingDetailsStepCompleted = Object(runtime["l" /* ref */])(false);
    const addresses = Object(runtime["a" /* computed */])(() => userBilling.value ? userBillingGetters["a" /* default */].getAddresses(userBilling.value) : []);
    const canMoveForward = Object(runtime["a" /* computed */])(() => !loading.value && billingDetails.value && Object.keys(billingDetails.value).length > 0);
    const hasSavedBillingAddress = Object(runtime["a" /* computed */])(() => {
    ...
    const handleAddressSubmit = reset => async () => {
      ...
      if (addressId !== null && setAsDefault.value) {
        const [chosenAddress] = userBillingGetters["a" /* default */].getAddresses(userBilling.value, {
          id: addressId
        });
    ...
    const handleCheckSameAddress = async value => {
      ...
      if (value) {
        ...
        billingDetails.value = {
          ...Object(address["c" /* formatAddressReturnToData */])(shippingDetails.value)
        };
        currentAddressId.value = null;
        setAsDefault.value = false;
        if (billingDetails.value.country_code) {
          country.value = await searchCountry({
            id: billingDetails === null || billingDetails === void 0 ? void 0 : billingDetails.value.country_code
          });
        }
        return;
      }
    ...
    const handleAddNewAddressBtnClick = () => {
      currentAddressId.value = null;
      billingDetails.value = Object(address["d" /* getInitialCheckoutAddressForm */])();
    ...
    const handleSetCurrentAddress = async customerAddress => {
      ...
      billingDetails.value = Object(address["a" /* addressFromApiToForm */])(customerAddress);
    ...
    Object(runtime["g" /* onMounted */])(async () => {
      ...
      const [loadedBillingInfoBoundToCart, loadedUserBilling, loadedCountries] = await Promise.all([loadBilling(), loadUserBilling(), loadCountries()]);
      const [defaultAddress = null] = userBillingGetters["a" /* default */].getAddresses(loadedUserBilling, {
      ...
      if (wasBillingAddressAlreadySetOnCart) {
        const userAddressIdenticalToSavedCartAddress = Object(address["b" /* findUserAddressIdenticalToSavedCartAddress */])(loadedUserBilling === null || loadedUserBilling === void 0 ? void 0 : loadedUserBilling.addresses, loadedBillingInfoBoundToCart);
      ...
      if ((_a = billingDetails.value) === null || _a === void 0 ? void 0 : _a.country_code) {
        country.value = await searchCountry({
...
// CONCATENATED MODULE: ./modules/checkout/pages/Checkout/Billing.vue?vue&type=script&lang=ts&
 /* harmony default export */ var Checkout_Billingvue_type_script_lang_ts_ = (Billingvue_type_script_lang_ts_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./modules/checkout/pages/Checkout/Billing.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  Checkout_Billingvue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  injectStyles,
